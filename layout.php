...
if (isset($_REQUEST["diff"]))
{
	...
	if (count($newpost))
	{
		...
		if (count($oldpost))
		{
			...
			echo "Exibir ";
			echo "<a title=\"Não mostrar linhas modificadas ou inseridas\" style=\"padding:1px 4px 3px 4px;\" id=\"oldlink\" href=\"javascript:showold()\">antiga versão</a> | ";
			echo "<a title=\"Não mostrar linhas removidas da vers?o antiga\" style=\"padding:1px 4px 3px 4px;\" id=\"newlink\" href=\"javascript:shownew()\">nova versão</a> | ";
